    ...
    public class Startup
    {
        ...
        private static void SeedData(IApplicationBuilder app)
        {
            using (var serviceScope = app.ApplicationServices.GetRequiredService<IServiceScopeFactory>().CreateScope())
            {
                ...
                context.Set<FarmField>().Add(new FarmField {Name = "Bob's Local Farm", Active = true, Dimensions = new Dimensions {Width = 10, Height = 5}, Description = "Blue Berries"});
                context.Set<FarmField>().Add(new FarmField {Name = "Hickory Homestead", Active = false, Dimensions = new Dimensions {Width = 15, Height = 10}, Description ="Black Berries"});
                context.Set<FarmField>().Add(new FarmField {Name = "Ms. Mary's Strawberries", Active = true, Dimensions = new Dimensions { Width = 10, Height = 5 }, Description="Strawberries" });
                context.Set<FarmField>().Add(new FarmField {Name = "NOLA Farmstead", Active = true, Dimensions = new Dimensions {Width = 100, Height = 50}, Description="Tomatoes"});
                context.Set<FarmField>().Add(new FarmField { Name = "Cajun Acres", Active = true, Dimensions = new Dimensions { Width = 100, Height = 50 }, Description = "Potatos" });
                context.Set<FarmField>().Add(new FarmField { Name = "Geaux Farmstead", Active = true, Dimensions = new Dimensions { Width = 100, Height = 50 }, Description = "Okra" });
                context.Set<FarmField>().Add(new FarmField { Name = "Southern LA Fields", Active = true, Dimensions = new Dimensions { Width = 100, Height = 50 }, Description = "Watermelons" });
                context.SaveChanges();
            }
        }
